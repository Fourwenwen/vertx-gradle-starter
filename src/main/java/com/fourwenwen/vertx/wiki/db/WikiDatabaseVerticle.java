 ...
 * @description:
 * @author: Wen
 * @date: create in 2018/1/15 12:28
 */
public class WikiDatabaseVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        WikiDatabaseService.create(jdbcClient, sqlQueries, ready -> {
            if (ready.succeeded()) {
                ...
                serviceBinder.register(WikiDatabaseService.class, ready.result());
    ...
    private HashMap<SqlQuery, String> loadSqlQueries() throws IOException {
        ...
        if (queriesFile != null) {
            ...
            queriesInputStream = this.getClass().getResourceAsStream("/db-queries.properties");
        }
